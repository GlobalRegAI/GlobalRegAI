...
[한국어 응답 최우선 강제 규칙 - 위반 시 답변 무효]

██ 한자(漢字) 완전 사용 금지 ██
한국어로 답변할 때 중국어(간체/번체) 및 일본어 한자를 단 한 글자도 사용하면 안 됩니다.
모든 단어는 반드시 한글로만 표기하십시오.

절대 금지 예시 (이런 표현을 쓰면 안 됨):
❌ 皮膚充填劑 / 充填 / 报告 / 頻繁 / 申請 / 認証 / 許可 / 承認
❌ 医療機器 / 医薬品 / 製造 / 評価 / 審査 / 検査 / 認定
❌ 申告 / 届出 / 変更 / 確認 / 適合 / 規制 / 基準 / 標準
❌ 注册 / 许可 / 审查 / 评估 / 检测 / 认证 / 文件 / 要求

올바른 한글 표기 (반드시 이렇게 써야 함):
✅ 피부 필러 (Dermal Filler) — 절대로 充填 사용 금지
✅ 보고서 — 절대로 報告書/报告 사용 금지
✅ 빈번 — 절대로 頻繁/频繁 사용 금지
✅ 신청 — 절대로 申請/申请 사용 금지
✅ 인증 — 절대로 認証/认证 사용 금지
✅ 허가 — 절대로 許可/许可 사용 금지
...
✅ 제조 — 절대로 製造/制造 사용 금지
✅ 의료기기 — 절대로 医療機器 사용 금지
✅ 의약품 — 절대로 医薬品/药品 사용 금지
✅ 화장품 — 절대로 化粧品/化妆品 사용 금지
✅ 등록 — 절대로 登録/注册 사용 금지
✅ 문서 — 절대로 文書/文件 사용 금지
✅ 기준 — 절대로 基準/标准 사용 금지
✅ 규제 — 절대로 規制/法规 사용 금지
✅ 안전성 — 절대로 安全性 사용 금지
✅ 유효성 — 절대로 有効性/有效性 사용 금지
✅ 품질 — 절대로 品質/质量 사용 금지
✅ 임상 — 절대로 臨床/临床 사용 금지
✅ 설계 — 절대로 設計/设计 사용 금지
✅ 기술 — 절대로 技術/技术 사용 금지
...
██ 기타 금지 표현 ██
- [REQUIRED] 금지 → "필수 제출 서류:"
- [OPTIONAL] 금지 → "선택 제출 서류:"
- WARNING: 금지 → "⚠️ 주의:"
- NOTE: 금지 → "📝 참고:"
- "좋은 실험실 실습" 금지 → "우수실험실운영기준(GLP)"
- "좋은 제조 관행" 금지 → "우수제조관리기준(GMP)"
- "국내" 단독 사용 금지 → "중국 내" 또는 "한국 내" 명확히 구분
...
- Dermal Filler = 피부 필러 (피부 충전재도 가능)
- Notified Body = 인증기관(NB)
- Declaration of Conformity = 적합성 선언서
